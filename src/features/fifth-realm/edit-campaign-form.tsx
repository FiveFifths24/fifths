...
export function EditCampaignForm({
  ...
  function interestValues() {
    const stored = state.values?.interestIds;
...
>
  <fieldset className="rounded-[1.75rem] border border-white/10 bg-black/20 p-5 sm:p-7">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          <TextField
            defaultValue={value("title", campaign.title)}
          ...
          <SelectField
            defaultValue={value("genre", campaign.genre)}
        ...
        <div className="mt-5">
          <TextAreaField
            defaultValue={value("summary", campaign.summary)}
        ...
        <div className="mt-5">
          <TextAreaField
            defaultValue={value("premise", campaign.premise)}
        ...
        <div className="mt-5">
          <TextField
            defaultValue={value("tone", campaign.tone)}
      ...
      <fieldset className="rounded-[1.75rem] border border-white/10 bg-black/20 p-5 sm:p-7">
        ...
        <SectionIntro
          description="Update the practical expectations for how, when, and where the campaign happens."
          step="Step 02"
          title="How It Works"
        />
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <SelectField
            defaultValue={value("format", campaign.format)}
          ...
          <TextField
            defaultValue={value(
              ...
              String(campaign.estimated_session_minutes),
            )}
          ...
          <TextField
            defaultValue={value(
              "playerCapacity",
              String(campaign.player_capacity),
            )}
            error={firstFieldError(state, "playerCapacity")}
            hint={`Cannot be lower than ${campaign.active_player_count} active player${
              campaign.active_player_count === 1 ? "" : "s"
            }.`}
            label="Player Seats"
            max={12}
            min={Math.max(1, campaign.active_player_count)}
            name="playerCapacity"
            required
            type="number"
          />
          ...
          <SelectField
            defaultValue={value("timezone", campaign.timezone)}
      ...
      <fieldset className="rounded-[1.75rem] border border-white/10 bg-black/20 p-5 sm:p-7">
        <legend className="sr-only">What Participants Should Know</legend>

        <SectionIntro
          description="Update the safety, access, and participation expectations."
          step="Step 03"
      ...
      <fieldset className="rounded-[1.75rem] border border-[#22d3ee]/15 bg-[linear-gradient(145deg,rgba(34,211,238,0.035),rgba(0,0,0,0.2))] p-5 sm:p-7">
        ...
        <SectionIntro
          description="Update the signals used to help people understand whether this campaign fits their current capacity."
          step="Step 04"
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          <SelectField
            defaultValue={value("modeId", campaign.mode_id)}
          ...
          <TextField
            defaultValue={value(
              "minimumEnergy",
              String(campaign.minimum_energy),
            )}
          ...
          <TextField
            defaultValue={value(
              "maximumEnergy",
              String(campaign.maximum_energy),
            )}
