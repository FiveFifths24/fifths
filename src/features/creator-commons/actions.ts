  ...
  try {
    ...
    if (error || !data) {
      return {
        status: "error",
        message:
          "The opportunity could not be created. Confirm your creator or scoped Circle-host authority.",
      };
    }
    opportunityId = data;
  } catch {
    return {
      status: "error",
      message:
        "Creator Commons is unavailable until the Phase 6 migration is connected.",
    };
  }
...
export async function setOpportunityStatusAction(formData: FormData) {
  ...
  if (!parsed.success) redirect("/home/commons/manage?status=invalid");
...
export async function saveOpportunityAction(formData: FormData) {
  ...
  if (!parsed.success) redirect("/home/commons?saved=invalid");
...
export async function withdrawOpportunityResponseAction(formData: FormData) {
  ...
  if (!parsed.success) redirect("/home/commons/responses?response=invalid");
...
export async function reviewOpportunityResponseAction(formData: FormData) {
  ...
  if (!parsed.success) redirect("/home/commons/manage?response=invalid");
...
export async function confirmOpportunityCompletionAction(formData: FormData) {
  ...
  if (!parsed.success) redirect("/home/commons/responses?completion=invalid");
...
export async function confirmManagedOpportunityCompletionAction(
  ...
  if (!parsed.success) redirect("/home/commons/manage?completion=invalid");
