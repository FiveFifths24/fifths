      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="relative mt-8 overflow-hidden rounded-[2rem] border border-[#a855f7]/30 bg-[linear-gradient(145deg,rgba(108,20,206,0.12),rgba(3,3,7,0.9)_50%,rgba(243,89,210,0.07))] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.3)] sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-bold text-white">Customize Profile</h2>
          </div>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-white/50">
            Make this page feel like your own corner of SIGNAL.
          </p>
...
spotlightCategory: profile.spotlight_category ?? "",
...
currentGame: profile.current_game ?? "",
currentGameDescription: profile.current_game_description ?? "",
currentGameUrl: profile.current_game_url ?? "",

currentReading: profile.current_reading ?? "",
currentReadingDescription: profile.current_reading_description ?? "",
currentReadingUrl: profile.current_reading_url ?? "",

currentFood: profile.current_food ?? "",
currentFoodDescription: profile.current_food_description ?? "",
currentFoodUrl: profile.current_food_url ?? "",
                viewMyLabel: profile.view_my_label ?? "",
                viewMyUrl: profile.view_my_url ?? "",
        ...
        <section className="mt-8 rounded-[2rem] border border-[#a855f7]/20 bg-[linear-gradient(145deg,rgba(108,20,206,0.08),rgba(3,3,7,0.92))] p-6 sm:p-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white">Top Friends</h2>
          </div>
          <p className="mt-3 text-sm leading-6 text-white/45">
            Choose up to three friends to feature on your profile.
          </p>
          <div className="mt-6">
