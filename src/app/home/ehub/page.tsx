  ...
  return (
    <>
      ...
      <Container className="!max-w-[120rem] pb-24">
        <section className="mt-20 text-center" id="inside-the-ehub">
          <div className="mt-15">
            <div className="relative my-6 overflow-hidden bg-transparent px-5 py-8 sm:px-8 lg:left-1/2 lg:w-[94vw] lg:max-w-[104rem] lg:-translate-x-1/2 lg:px-8 lg:py-12">
              <div className="text-center">
                ...
                <h2 className="mx-auto mt-4 max-w-4xl text-4xl font-black text-white [text-shadow:0_0_4px_rgba(255,255,255,0.95),0_0_10px_rgba(255,255,255,0.75),0_0_20px_rgba(139,92,246,0.45)] sm:text-6xl">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-white/45">
                  ...
                  creativity, collaboration, entrepreneurship, and community
                  engagement.
                </p>
              </div>
              ...
              <div className="mt-12 grid items-center gap-8 lg:grid-cols-[1.35fr_3fr_1.35fr] lg:gap-10">
                <div className="space-y-10 text-center lg:space-y-12 lg:text-right">
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-white/55 lg:text-lg lg:leading-8">
                      Competitive gaming, tournaments, and digital skill
                      building.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-white/55 lg:text-lg lg:leading-8">
                      Podcasting, streaming, production, editing, and brand
                      development.
                    </p>
                  </div>
                ...
                <div className="space-y-10 text-center lg:space-y-12 lg:text-left">
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-white/55 lg:text-lg lg:leading-8">
                      A comfortable space to relax, connect, and build
                      community.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-white/55 lg:text-lg lg:leading-8">
                      Immersive storytelling, experiential learning, and
                  ...
                  <div>
                    ...
                    <p className="mt-3 text-base leading-7 text-white/55 lg:text-lg lg:leading-8">
                      Quiet workspaces for remote work, study, and
                      collaboration.
                    </p>
                  </div>
              ...
              <div className="mt-15 rounded-[1.6rem] bg-[linear-gradient(90deg,#3b82f6_0%,#8b5cf6_25%,#f472b6_50%,#fb923c_75%,#a3e635_100%)] p-px">
                <div className="rounded-[calc(1.6rem-1px)] bg-[#020205] p-7 sm:p-8 lg:p-10">
                  <p className="text-center text-sm font-black tracking-[0.18em] text-white uppercase [text-shadow:0_0_4px_rgba(255,255,255,0.95),0_0_10px_rgba(255,255,255,0.75),0_0_20px_rgba(139,92,246,0.45)] sm:text-base lg:text-lg">
              ...
              <div className="mt-10 w-full rounded-[1.75rem] border border-white bg-black/40 px-7 py-10 text-center sm:px-10 lg:px-12 lg:py-12">
                ...
                <p className="mx-auto mt-5 max-w-5xl text-base leading-7 text-white/55 sm:text-lg sm:leading-8 lg:text-xl lg:leading-9">
                  Move from competition to creation, from work to play, or step
                  away entirely when you need a quieter environment.
                </p>
        ...
        <section className="mt-28">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-white/50 sm:text-lg">
              Our eHub is designed to move people beyond access. Members can
              build practical skills, create real work, explore careers, launch
              ideas, and connect with resources that help turn interests into
              opportunity.
            </p>
          </div>
          ...
          <div className="mx-auto mt-8 max-w-4xl text-center">
            <p className="text-sm leading-7 text-white/35 sm:text-base">
              Skills developed inside the eHub are designed to connect interest
              with experience — and experience with real pathways forward.
            </p>
          </div>
        </section>
        ...
        <section className="mt-28">
          <div className="text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-white/50 sm:text-lg">
              The eHub is designed to create opportunities across gaming,
              technology, media, hospitality, events, production, and community
              operations.
            </p>
          </div>
            ...
            <div className="grid items-center gap-10 px-7 py-10 text-center sm:px-10 lg:grid-cols-[0.9fr_1.1fr] lg:px-12 lg:py-12 lg:text-left">
              <div>
                <div className="text-center lg:text-left">
                  ...
                  <p className="mx-auto mt-5 max-w-md text-base leading-7 text-white/48 lg:mx-0">
                    Entry-level hourly roles are planned to begin at $21+ per
                    hour, with additional opportunities across events,
                    technology, media, hospitality, and operations.
                  </p>

                  <div className="mt-6 flex flex-wrap justify-center gap-2 lg:justify-start">
                    {["Entry-Level", "Hourly", "Career Building"].map(
                      (item) => (
                        <span
              ...
              <div>
                <p className="mx-auto max-w-2xl text-base leading-8 text-white/52 lg:mx-0 lg:text-lg">
                  Planned starting compensation for entry-level hourly
                  positions. Final pay, schedules, requirements, hiring
                  timelines, and individual role structures will be announced
                  before opening.
                </p>

                <div className="mt-7 grid grid-cols-2 gap-3 sm:grid-cols-4">
                  {["Full-Time", "Part-Time", "Event Staff", "Internships"].map(
                    (item) => (
                      <div
          ...
          <div className="mt-6 overflow-hidden rounded-[2rem] border border-white/10 bg-black/45 p-7 sm:p-9 lg:p-10">
            ...
            <div className="mx-auto mt-8 max-w-3xl border-t border-white/8 pt-6 text-center">
              <p className="text-sm leading-7 text-white/35">
                ...
                postings. Roles and staffing needs may change as the eHub moves
                toward opening.
              </p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[calc(2rem-1px)] bg-[#020205] px-6 py-12 sm:px-10 lg:px-14 lg:py-16">
            ...
            <div className="relative grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
              <div className="text-center lg:text-left">
                ...
                <p className="mx-auto mt-6 max-w-2xl text-base leading-8 text-white/52 sm:text-lg lg:mx-0">
                  ...
                  technology, furniture, programming, people, and partners who
                  believe communities deserve infrastructure built for their
                  future.
                </p>

                <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-white/38 lg:mx-0">
                  Every contribution helps move the eHub closer to opening its
                  doors.
                </p>
              ...
              <div className="grid gap-4">
                <div className="rounded-[1.5rem] border border-[#4169ff]/25 bg-[#4169ff]/[0.04] p-6 text-center lg:text-left">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/45 sm:text-base">
                    Contributions help support construction, equipment,
                    technology, furnishings, and the infrastructure needed to
                    open the eHub.
                  </p>
                </div>
                ...
                <div className="rounded-[1.5rem] border border-[#ef4fb5]/25 bg-[#ef4fb5]/[0.04] p-6 text-center lg:text-left">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/45 sm:text-base">
                    ...
                    support access to technology and career-building
                    experiences.
                  </p>
                </div>
                ...
                <div className="rounded-[1.5rem] border border-[#8ee71d]/25 bg-[#8ee71d]/[0.04] p-6 text-center lg:text-left">
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/45 sm:text-base">
                    Employers, educators, technology partners, creators, and
                    community organizations can help create pathways that extend
                    beyond the eHub.
                  </p>
                </div>
              </div>
            ...
            <div className="relative mt-12 border-t border-white/10 pt-7 text-center">
              <p className="mx-auto max-w-3xl text-sm leading-7 text-white/35 sm:text-base">
                This project is community-powered. Every contribution,
                partnership, and shared resource brings us one step closer to
                making the Five Fifths eHub real.
              </p>
            </div>
