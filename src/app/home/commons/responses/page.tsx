  ...
  const opportunityResult =
    opportunityIds.length
      ? await supabase
          ...
          .select(
            "id, title, summary, status, creator_display_name",
          )
          .in(
            "id",
            opportunityIds,
    ...
    <div>
      ...
      "error" ? (
        <StatusMessage
          ...
          tone="error"
        >
          Completion could not be confirmed. The opportunity must be closed
          and your response accepted.
        </StatusMessage>
      ) : null}
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-white/45">
              Everything you&apos;ve submitted through Creator Commons will
              stay organized here.
            </p>
          </div>
        </div>
        ...
        {responses.length ? (
                  ...
                  >
                    <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                      <div className="max-w-3xl">
                        ...
                        <p className="mt-4 text-xs font-bold uppercase tracking-[0.14em] text-white/30">
                          Created by{" "}
                          {
          ...
          <div className="mt-7">
            <PreviewState title="No Responses Yet">
              When you respond to a published Creator Commons opportunity,
              your private response history will appear here.
            </PreviewState>
          </div>
        )}
      </section>
