  ...
  <div className="mx-auto text-center sm:text-left">
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end lg:gap-12">
        <div className="max-w-4xl">
          <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#22d3ee]">
            <Compass
              aria-hidden="true"
              className="size-4"
            />
...
<p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-neutral-300 sm:mx-0">
  Fifth Realm is where players, storytellers, game masters, and anime fans find campaigns and shared worlds built around clear expectations. 
Discover experiences shaped by gaming, anime, fantasy, fandom, collaborative storytelling, and the way you actually like to play.
          </p>
        </div>

        <ButtonLink
          className="min-h-12 min-w-[12.5rem] whitespace-nowrap border-0 bg-gradient-to-r from-[#0891b2] via-[#22d3ee] to-[#6c14ce] px-7 text-sm text-white shadow-lg shadow-[#22d3ee]/15 hover:brightness-110"
      ...
      <StatusMessage className="mt-8">
        <span>
          <strong>Fifth Realm Boundary:</strong>{" "}
          Campaigns organize participation, applications, and verified
          completion. Fifth Realm does not host copyrighted rules, virtual
          tabletop tools, private chat, or payments.
        </span>
      </StatusMessage>
      ...
      ====================================================== */}
      <section
        aria-labelledby="campaign-discovery-heading"
        className="mt-10"
      >
