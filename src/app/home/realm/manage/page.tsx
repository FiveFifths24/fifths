...
{modeResult.error || interestResult.error ? (
        ...
        >
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -right-24 -top-24 size-72 rounded-full bg-[#22d3ee]/[0.06] blur-[110px]"
          />

          <div className="relative z-10">
            <p className="font-mono text-[0.6rem] font-bold uppercase tracking-[0.2em] text-[#22d3ee]/70">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/50 sm:text-base">
              Shape the world, set the rhythm, and make it clear who will feel at home in the campaign.
            </p>
