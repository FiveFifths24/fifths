...
<div className="mt-10 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
  <section className="relative overflow-hidden rounded-[2rem] border border-[#6c14ce]/25 bg-black/45 p-4 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-6">
    ...
    <div
      aria-hidden="true"
      className="pointer-events-none absolute -right-24 -top-24 size-64 rounded-full bg-[#6c14ce]/15 blur-[100px]"
    />
...
<aside className="relative overflow-hidden rounded-[2rem] border border-[#6c14ce]/25 bg-black/45 p-12 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8">
  <div
    aria-hidden="true"
    className="pointer-events-none absolute -bottom-24 -right-24 size-64 rounded-full bg-[#f359d2]/10 blur-[110px]"
  />
...
<section className="relative mt-10 overflow-hidden rounded-[2rem] border border-[#6c14ce]/25 bg-black/45 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8 lg:p-10">
  <div
    aria-hidden="true"
    className="pointer-events-none absolute -right-28 -top-28 size-80 rounded-full bg-[#6c14ce]/15 blur-[120px]"
  />
...
As new experiences, spaces, and opportunities become available, your
  preferences and current Pulse will help shape what rises into your feed.
      </p>
    ...
    {matchingDataIncomplete ? (
      <StatusMessage className="mt-6">
        Some recommendation details could not load, so fewer matching reasons
...
<ButtonLink href="/home/sessions">
  Sessions
</ButtonLink>

<ButtonLink href="/home/circles">
  Circles
</ButtonLink>

<ButtonLink href="/home/commons">
  Commons
</ButtonLink>

<ButtonLink href="/home/realm">
  Realm
</ButtonLink>
    </div>
    ...
    <div className="mt-7 border-t border-white/10 pt-6">
      <p className="text-sm leading-6 text-white/40">
        Your feed will evolve with you, bringing forward what best fits your
  preferences, energy, and how you want to show up.
      </p>
    </div>
    ...
    {unifiedRecommendations.length ? (
      ...
      <div className="mt-10 flex min-h-56 flex-col items-center justify-center rounded-[1.5rem] border border-[#6c14ce]/25 bg-black/20 px-6 py-12 text-center">
        ...
        <p className="mt-2 max-w-lg text-sm leading-6 text-white/45">
          Your Pulse is active and your feed is evolving. As new Sessions, Circles, Commons, and Realm
  experiences become available, the ones that fit you will begin appearing here.
        </p>
      </div>
    ) : (
