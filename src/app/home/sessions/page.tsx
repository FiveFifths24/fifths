...
export default async function SessionsPage() {
  ...
  return (
    <div>
      <div className="flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="flex items-center gap-2 text-xs font-bold tracking-[0.2em] text-red-400 uppercase">
            <CalendarRange aria-hidden="true" className="size-4" /> Shared
            Sessions
          </p>
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-neutral-300">
            Discover published FIFTHS experiences, understand the capacity and
            fit, and register with one account. No preview card is presented as
            a live Session.
          </p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row">
          <ButtonLink href="/home/registrations" variant="secondary">
            <TicketCheck aria-hidden="true" className="size-4" /> My
            registrations
          </ButtonLink>
          <ButtonLink href="/home/sessions/host">
            <Plus aria-hidden="true" className="size-4" /> Host a Session
          </ButtonLink>
        </div>
      </div>
      ...
      <section className="mt-10" aria-labelledby="session-results-heading">
        <div className="flex items-center gap-3">
          <Sparkles aria-hidden="true" className="size-5 text-red-400" />
          <h2
