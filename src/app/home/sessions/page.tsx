  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-[#992bff]">
            <CalendarRange
              aria-hidden="true"
              className="size-4"
            />
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-neutral-300">
            ...
            together — from game nights, workshops, coworking, and networking
            to creator meetups, community events, campaigns, and more.
            Discover what fits your interests, availability, energy, and
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <ButtonLink
            className="min-h-12 min-w-[12.5rem] whitespace-nowrap border-[#992bff]/35 bg-black/40 px-7 text-sm text-white/85 shadow-none hover:border-[#992bff]/65 hover:bg-[#992bff]/10 hover:text-white"
            href="/home/registrations"
            variant="secondary"
          >
            <TicketCheck
              aria-hidden="true"
              className="size-4 text-[#992bff]"
            />
            My Registrations
          </ButtonLink>

          <ButtonLink
            className="min-h-12 min-w-[12.5rem] whitespace-nowrap border-0 bg-gradient-to-r from-[#6c14ce] via-[#a855f7] to-[#992bff] px-7 text-sm text-white shadow-lg shadow-[#6c14ce]/20 hover:brightness-110"
      ...
      {pulseInput ? (
        ...
        <StatusMessage className="mt-8">
          <span className="font-bold">
            Browsing by start time.
          </span>{" "}
          Check your Pulse to receive transparent Session ordering based on
          present capacity.{" "}
          <Link
