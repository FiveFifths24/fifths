...
useEffect(() => {
  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24">
      ...
      >
        <div className="absolute left-[-12rem] top-[15%] size-[34rem] rounded-full bg-[#6c14ce]/12 blur-[150px]" />
        <div className="absolute right-[-10rem] top-[20%] size-[30rem] rounded-full bg-[#f359d2]/10 blur-[140px]" />
      ...
      <div className="relative mx-auto w-full max-w-[76rem] px-4 sm:px-6">
        ...
        <div className="relative rounded-[2.6rem] border border-white/15 bg-[linear-gradient(145deg,#121217_0%,#08080c_38%,#050507_100%)] p-3 shadow-[0_35px_100px_rgba(0,0,0,0.72),inset_0_1px_0_rgba(255,255,255,0.04),inset_0_-18px_36px_rgba(0,0,0,0.28)] sm:p-5 lg:rounded-[3.25rem] lg:p-7">
          ...
          <div className="rounded-[2.15rem] border border-[#6c14ce]/25 bg-[#050508] p-3 sm:p-5 lg:rounded-[2.7rem] lg:p-7">
            {/* Receiver header */}
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3 px-1 font-mono text-[0.55rem] uppercase tracking-[0.18em] text-white/35 sm:mb-5 sm:text-[0.62rem]">
              <div className="flex items-center gap-3">
                <span className="text-[#69cc0c]">
                  SIGNAL // RECEIVER_001
                </span>
...
/>
              ...
              {/* Screen status */}
              <div className="relative z-30 flex items-center justify-between gap-4 font-mono text-[0.5rem] uppercase tracking-[0.18em] text-white/30 sm:text-[0.58rem]">
                <span>
              ...
              <div className="relative z-10 mx-auto mt-10 max-w-[52rem] text-center sm:mt-12">
                <p
                  className="font-mono text-[0.6rem] font-bold uppercase tracking-[0.24em] sm:text-[0.7rem]"
                ...
                <h1 className="display-type mt-5 text-[clamp(3.1rem,7vw,7rem)] leading-[0.88] tracking-[-0.055em]">
                  <span className="block text-[#f2f0ed]">
                    {station.title}
                  </span>
      ...
      {isTuning
        ...
        : `Signal Locked // ${station.name}`}
                ...
                <div className="mx-auto mt-8 flex max-w-[25rem] flex-col justify-center gap-3 sm:flex-row">
                  <ButtonLink
                    className="w-full border-0 bg-[linear-gradient(90deg,#1800ad_0%,#6c14ce_36%,#f359d2_70%,#7cff00_100%)] font-mono text-[0.66rem] tracking-[0.16em] uppercase text-white shadow-[0_0_28px_rgba(108,20,206,0.3)] hover:brightness-110 sm:w-auto sm:min-w-44"
                    href="/signup"
                  >
                    Join SIGNAL
                  </ButtonLink>
                  ...
                  <ButtonLink
                    className="w-full border border-white/20 bg-black/45 font-mono text-[0.66rem] tracking-[0.16em] uppercase text-white backdrop-blur-sm hover:border-white/40 hover:bg-white/10 sm:w-auto sm:min-w-36"
                    href="/login"
                    variant="secondary"
                  >
                    Log in
              ...
              {/* mobile station */}
              <div className="relative z-30 mt-10 flex items-center justify-between border-t border-white/10 pt-4 font-mono text-[0.5rem] uppercase tracking-[0.16em] text-white/30 sm:hidden">
                <span>
                  CH 01
                </span>
...
<div className="mt-6 hidden sm:grid sm:grid-cols-[1fr_15rem] sm:gap-6">
  ...
  <div className="rounded-[1.4rem] border border-white/10 bg-[#09090d] p-5 shadow-[inset_0_0_30px_rgba(0,0,0,0.65)]">
    <div className="mb-4 flex items-center justify-between font-mono text-[0.5rem] uppercase tracking-[0.18em] text-white/30">
...
<div className="relative mt-2 h-12 overflow-hidden rounded-md border border-white/10 bg-black/70">
  ...
  <div
    aria-hidden="true"
    className="absolute left-[9px] right-[9px] top-1/2 h-[2px] -translate-y-1/2 bg-[linear-gradient(90deg,#1800ad_0%,#6c14ce_30%,#f359d2_62%,#7cff00_100%)] opacity-70"
  />
  ...
  <div className="relative mx-[9px] mt-1 h-10">
    {stations.map((item, index) => (
      <button
        className="absolute top-0 flex -translate-x-1/2 flex-col items-center gap-1.5 font-mono text-[0.46rem] uppercase tracking-[0.1em] text-white/25 transition hover:text-white/70"
        key={item.name}
  ...
  <div className="grid grid-rows-[1fr_auto] gap-4">
    ...
    <div className="flex items-center justify-center gap-5 rounded-[1.4rem] border border-white/10 bg-[#09090d] px-5 py-4">
      <div className="text-center">
        <div className="relative mx-auto size-14 rounded-full border border-white/15 bg-[radial-gradient(circle_at_35%_30%,#34343a,#0a0a0d_68%)] shadow-[0_6px_16px_rgba(0,0,0,0.75)]">
          <span className="absolute left-1/2 top-2 h-3 w-px -translate-x-1/2 bg-white/35" />
        </div>

        <p className="mt-2 font-mono text-[0.44rem] uppercase tracking-[0.14em] text-white/25">
          Gain
        </p>
      </div>
    ...
    <div className="rounded-[1.4rem] border border-white/10 bg-[#08080b] p-4">
      ...
      <p className="mt-3 text-center font-mono text-[0.42rem] uppercase tracking-[0.18em] text-white/20">
        Signal Output
      </p>
    </div>
  </div>
            ...
            {/* Equipment label */}
            <div className="mt-5 flex items-center justify-between border-t border-white/[0.07] pt-4 font-mono text-[0.46rem] uppercase tracking-[0.16em] text-white/20">
              <span>
                FIVE FIFTHS // SIGNAL
              </span>
