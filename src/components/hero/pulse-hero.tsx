...
export function PulseHero() {
  return (
    <section className="relative min-h-[88svh] overflow-visible">
      <div className="relative z-10 flex min-h-[88svh] w-full items-center px-5 pb-12 pt-24 sm:px-7 lg:px-10 xl:px-12">
        <div className="mx-auto w-full max-w-[72rem] text-center lg:mx-0 lg:text-left">
          ...
          <div className="inline-flex items-center justify-center gap-3 rounded-full border border-[#6c14ce]/45 bg-black/35 px-5 py-2.5 backdrop-blur-xl">
            ...
            <span className="font-mono text-[0.6rem] font-bold uppercase tracking-[0.2em] text-white/80 sm:text-[0.65rem]">
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row lg:justify-start">
            {/* Full ombre button */}
            <Link
              className="inline-flex min-h-12 w-full items-center justify-center rounded-full bg-[linear-gradient(90deg,#1800ad_0%,#6c14ce_35%,#f359d2_68%,#7cff00_115%)] px-7 text-[0.7rem] font-bold uppercase tracking-[0.16em] text-white shadow-[0_0_30px_rgba(108,20,206,0.24)] transition duration-300 hover:scale-[1.02] hover:brightness-110 sm:w-auto"
              href="/signup"
            >
              Join SIGNAL
            </Link>
            ...
            >
              <span className="flex min-h-[46px] w-full items-center justify-center rounded-full bg-[#020205]/95 px-7 sm:w-auto">
                <span className="bg-[linear-gradient(90deg,#1800ad_0%,#6c14ce_35%,#f359d2_68%,#7cff00_115%)] bg-clip-text text-[0.7rem] font-bold uppercase tracking-[0.16em] text-transparent [-webkit-text-fill-color:transparent]">
                  Explore Ecosystem
                </span>
              </span>
            </Link>
          ...
          >
            {featureLinks.map((feature) => (
              <Link
                className="inline-flex min-h-10 items-center justify-center rounded-full border bg-black/30 px-5 font-mono text-[0.58rem] font-bold uppercase tracking-[0.16em] backdrop-blur-xl transition duration-300 hover:bg-white/[0.06]"
                href={feature.href}
                key={feature.href}
                style={{
