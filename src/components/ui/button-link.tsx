  ...
  return (
    <Link
      className={cn(
        ...
        variant === "primary" &&
          "border border-white/10 bg-gradient-to-r from-[#6c14ce] via-[#a855f7] to-[#f359d2] text-white shadow-lg shadow-[#6c14ce]/20 hover:shadow-[#a855f7]/25 hover:brightness-110",
        variant === "secondary" &&
