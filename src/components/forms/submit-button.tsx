  ...
  return (
    <button
      className={cn(
        ...
        variant === "primary" &&
          "border-transparent bg-gradient-to-r from-[#6c14ce] via-[#a855f7] to-[#f359d2] shadow-lg shadow-[#992bff]/25 hover:-translate-y-0.5 hover:brightness-110 hover:shadow-[#f359d2]/25 active:translate-y-0",
        variant === "secondary" &&
